  ...
  return (
    <AuroraBackground className={"bg-green-900"}>
      <div className={"flex flex-col justify-center items-center container mx-auto"}>
        <TextPopUp>
          <h1 className="text-xl md:text-2xl mt-[120px] text-center font-bold from-green-200 via-gray-100 to-green-200 bg-gradient-to-r bg-clip-text text-transparent  max-w-80 md:max-w-screen-md mx-auto">
